...
const VALID_INVITE_HASHES = new Set<string>([
  ...
  "5f3c8c69f261862f7d6c124a29354587f1fc7decae90f004a905a48eb9c72be9", // SOMMERELI
...
const HASH_TO_INVESTOR_ID: Record<string, string> = {
  ...
  "5f3c8c69f261862f7d6c124a29354587f1fc7decae90f004a905a48eb9c72be9": "sommereli",      // SOMMERELI
};
