...
export const DIRECT_INVESTORS: DirectInvestor[] = [
  {
    ...
    positions: [
      ...
      { category: "Short-term Notes",  issueDate: "2025-11-03", securityType: "Short-term Note", company: "Audily Inc.", companyId: "audily", principal: 25_000, repaid: 25_000, interestDividend: 2_187.50, costBasis: 25_000, estimatedValue: 0, annualizedReturnPct: 29.3 },
