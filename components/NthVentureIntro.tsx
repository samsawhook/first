...
const SCATTER_POINTS: [number, number, number][] = [
  ...
  // Extreme outliers — tiny funds, very high multiples
  [0.03,8.20,1],[0.04,7.50,1],[0.05,7.80,1],
  // High cluster x<0.1B
  [0.04,6.90,1],[0.06,6.50,1],[0.05,6.10,1],[0.07,5.70,1],[0.06,5.40,1],[0.08,5.10,1],[0.05,4.80,1],
  // Upper-mid cluster x<0.12B
  [0.04,4.50,1],[0.08,4.30,1],[0.10,4.10,1],[0.07,3.90,1],[0.09,3.70,1],[0.06,3.55,1],
  // Dense core cluster x=0.08–0.25B, y=2.5–3.5x
  [0.10,3.50,1],[0.08,3.35,1],[0.12,3.20,1],[0.10,3.10,1],[0.14,3.00,1],[0.12,2.90,1],
  [0.08,2.80,1],[0.15,2.72,1],[0.18,2.62,1],[0.12,2.55,1],[0.10,2.45,1],[0.20,2.50,1],
  // Cluster x=0.2–0.5B
  [0.22,2.40,1],[0.25,2.35,1],[0.28,2.28,1],[0.30,2.20,1],[0.32,2.12,1],[0.35,2.05,1],
  [0.38,2.00,1],[0.40,1.95,1],[0.42,1.90,1],[0.48,1.88,1],[0.50,1.85,1],
  // Trail x=0.5–2B
  [0.60,1.82,1],[0.70,1.80,1],[0.80,1.78,1],[1.00,1.75,1],[1.20,1.72,1],
  [1.50,1.70,1],[1.70,1.67,1],[2.00,1.65,1],
  // Trail x=2–10B
  [2.50,1.62,1],[3.00,1.60,1],[3.50,1.57,1],[4.00,1.55,1],[4.50,1.53,1],
  [5.00,1.52,1],[5.50,1.50,1],[6.00,1.48,1],[6.50,1.46,1],[7.00,1.44,1],
  [7.50,1.42,1],[8.50,1.40,1],[9.50,1.40,1],
  // Large fund outliers
  [11.0,1.65,1],[12.0,1.75,1],[14.5,1.48,1],[17.0,1.52,1],[20.5,1.45,1],
