...
const CO_FOUNDERS: TeamMember[] = [
  { name: "Sam Sawhook",    role: "Co-Founder", initials: "SS", color: "#c45a2d", photo: "/team/sam%20sawhook.jpg",    bio: "Army veteran (Operation Atlantic Resolve convoy commander) and startup operator. Co-founded nth Venture in 2021 and launched six employee-owned portfolio companies. Former U.S. GAO financial auditor — the supreme audit authority in the United States — with engagements at the SEC, DoD, and Treasury. Currently pursuing a Master of Accountancy." },
  { name: "Sam Johnston",   role: "Co-Founder", initials: "SJ", color: "#8a4a1a", photo: "/team/sam%20johnston.jpg",   bio: "Forbes Business Council member with a background spanning International Economics, Applied Psychology, and Marketing (Texas McCombs, Stanford, University of Wales Trinity Saint David). Leads brand strategy, investor communications, and new business launches across the nth Venture portfolio." },
  { name: "Michael Shamoun",role: "Co-Founder", initials: "MS", color: "#2a5a8a", photo: "/team/michael%20shamoun.jpg",bio: "Electrical engineering and computer architecture background (UT Dallas B.S., UT Austin M.S.). Former software engineer at General Motors and IBM before co-founding nth Venture. Leads all technology infrastructure across the platform and portfolio companies." },
  { name: "Nathan Deily",   role: "Co-Founder", initials: "ND", color: "#1a5a3a", photo: "/team/nathan%20deily.jpg",   bio: "Senior talent and organizational leadership roles at Microsoft, Honeywell, Raytheon, and LivePerson before co-founding nth Venture. M.S. in Labor Relations from Michigan State, Executive MBA from ASU W.P. Carey. Host of the Breakthrough Hiring Show podcast." },
  { name: "Jillian Palash", role: "Co-Founder", initials: "JP", color: "#5a3a6a", photo: "/team/jillian%20palash.jpg", bio: "Nearly 15 years in Fortune 50 corporate communications and public relations at top-ranked agencies and in-house roles. Joined nth Venture as a founding team member and serves on the leadership team at Falconer." },
];

const PORTCO_CEOS: TeamMember[] = [
  { name: "David Markowitz", role: "CEO, Audily",          initials: "DM", color: "#7a3a1a", photo: "/team/david%20markowitz.jpg", bio: "Award-winning audio producer and podcast executive. Former Podcast Manager at Netflix. Leads Audily's roster of branded audio content, original productions, and acquisitions — including the Rococo Punch and Pop Ups Studio networks, covered by Bloomberg and The Hollywood Reporter." },
  { name: "Doug Epperly",    role: "CEO, Merchant Boxes",  initials: "DE", color: "#2a5a2a", photo: "/team/doug%20epperly.jpg",    bio: "Over two decades in global supply chain and fulfillment. Founder of E3 Enterprises. Expanded Merchant Boxes into a custom packaging platform serving hundreds of e-commerce and retail brands." },
  { name: "John Light",      role: "CEO, SBR2TH",          initials: "JL", color: "#1a3a5a", photo: "/team/john%20light.jpg",      bio: "20+ years in specialized technical recruiting across contingent, retained, and RPO models. Built SBR2TH's proprietary Retingent and Pipelining hiring vehicles and its AI-driven talent platform (sbr2th.ai). Focused on Data Science, ML, and senior engineering placement." },
  { name: "Grant Typrin",    role: "CEO, Pigeon Service",  initials: "GT", color: "#4a4a1a", photo: "/team/grant%20typrin.jpg",    bio: "UT Austin McCombs graduate. Led operations at Certd, nth Venture's training certification marketplace, before expanding to oversee corporate finance and operations across multiple portfolio companies." },
];

const ADVISORS: TeamMember[] = [
  { name: "Neil Wolfson",   role: "Vice Chairman",   initials: "NW", color: "#1a5a3a", photo: "/team/neil%20wolfson.jpg",   bio: "Former President & CIO of Wilmington Trust Investment Management ($40B+ AUM). National Partner in Charge of KPMG's Investment Consulting Practice ($100B+ in assets)." },
  { name: "Jay Heller",     role: "Advisory Board",  initials: "JH", color: "#2a4a7a", photo: "/team/jay%20heller.jpg",    bio: "Senior member of Nasdaq's Capital Markets Team. Over 25 years in financial markets. Led execution of 2,300+ IPOs including Rivian, Airbnb, Coinbase, and Lyft." },
  { name: "Sandy Leeds",    role: "Advisory Board",  initials: "SL", color: "#5a3a6a", photo: "/team/sandy%20leeds.jpg",   bio: "Finance faculty at University of Arizona. 23 years at UT Austin McCombs. JD from UVA, MBA from UT Austin, CFA charterholder. Co-author of Investment Analysis & Portfolio Management. Former portfolio manager ($1.6B AUM)." },
  { name: "Steven Maasch",  role: "Advisory Board",  initials: "SM", color: "#3a5a5a", photo: "/team/steve%20maasch.jpg",  bio: "SVP Human Resources at Riverview Bank. Wharton-educated HR leader with experience scaling organizations at Avista Corporation, First Interstate BancSystem, and InfrastruX. Specialist in workforce planning, succession, and performance management." },
  { name: "Ted Ladd",       role: "Advisory Board",  initials: "TL", color: "#6a4a2a", photo: "/team/ted%20ladd.jpg",      bio: "Professor of Entrepreneurship at Hult International Business School. Harvard instructor. 15 teaching awards. PhD from Case, MBA from Wharton, MA from Johns Hopkins, BA triple major from Cornell. Latest startup acquired by Google for smartwatch software." },
];
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(280px, 100%), 1fr))", gap: 40 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, justifyContent: "center" }}>
              <div style={{ background: "#fafaf8", border: "1px solid #e8e6e0", borderRadius: 8, padding: "16px 20px" }}>
                ...
                <p style={{ fontSize: 13, color: "#888", margin: "0 0 2px" }}>Co-Founder</p>
